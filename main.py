...
from matrix import rotation_matrix, intrinsic_matrix, extrinsic_matrix
...
def draw_cube(cube):
    ...
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][1]/cube[2][1], cube[1][1]/cube[2][1]),
                     (cube[0][0]/cube[2][0], cube[1][0]/cube[2][0]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][4]/cube[2][4], cube[1][4]/cube[2][4]),
                     (cube[0][0]/cube[2][0], cube[1][0]/cube[2][0]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][1]/cube[2][1], cube[1][1]/cube[2][1]),
                     (cube[0][5]/cube[2][5], cube[1][5]/cube[2][5]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][4]/cube[2][4], cube[1][4]/cube[2][4]),
                     (cube[0][5]/cube[2][5], cube[1][5]/cube[2][5]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][7]/cube[2][7], cube[1][7]/cube[2][7]),
                     (cube[0][3]/cube[2][3], cube[1][3]/cube[2][3]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][2]/cube[2][2], cube[1][2]/cube[2][2]),
                     (cube[0][3]/cube[2][3], cube[1][3]/cube[2][3]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][7]/cube[2][7], cube[1][7]/cube[2][7]),
                     (cube[0][6]/cube[2][6], cube[1][6]/cube[2][6]))
    pygame.draw.line(window, (255, 255, 255),
                     (cube[0][2]/cube[2][2], cube[1][2]/cube[2][2]),
                     (cube[0][6]/cube[2][6], cube[1][6]/cube[2][6]))
    pygame.draw.line(window, (255, 255, 255),
...
def draw_coordinate_frame(proj):
    ...
    pygame.draw.line(window, (255, 0, 0),
                     (origin[0][0]/origin[2][0], origin[1][0]/origin[2][0]),
                     (x_axis[0][0]/x_axis[2][0], x_axis[1][0]/x_axis[2][0]))
    pygame.draw.line(window, (0, 255, 0),
                     (origin[0][0]/origin[2][0], origin[1][0]/origin[2][0]),
                     (y_axis[0][0]/y_axis[2][0], y_axis[1][0]/y_axis[2][0]))
    pygame.draw.line(window, (0, 0, 255),
                     (origin[0][0]/origin[2][0], origin[1][0]/origin[2][0]),
                     (z_axis[0][0]/z_axis[2][0], z_axis[1][0]/z_axis[2][0]))
...
def print_values():
    ...
    label = myfont.render(
        f"camera_x = {camera_pos[0,0]:.2f}", 1, (255, 255, 255))
    window.blit(label, (0, 70))
    label = myfont.render(
        f"camera_y = {camera_pos[1,0]:.2f}", 1, (255, 255, 255))
    window.blit(label, (0, 90))
    label = myfont.render(
        f"camera_z = {camera_pos[2,0]:.2f}", 1, (255, 255, 255))
